!Part 3: Evaluate Chebyshev Interpolant Derivative

program expansion; implicit none

integer, parameter :: n = 10, m = 3001
...
subroutine dump(m)
  ...
  vP = fP(x)
  do i = 1,m
     write (*,*) x(i), vP(i), sum(v*basisPrime(n,x(i))) !Evaluate the derivative and interpolant derivative
  end do
end subroutine
